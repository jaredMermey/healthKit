...
//  FoodTracker
//
//  Created by Jared Mermey on 12/29/14.
                ...
                if itemDictionary["_id"] != nil && itemDictionary["_id"] as String == idValue{
                    ...
                    if items?.count != 0 {
                        ...
                        if itemDictionary["fields"] != nil {
                            ...
                            if fieldsDictionary["usda_dictionary"] != nil {
                            ...
                            if usdaFieldsDictionary["CHOLE"] != nil {
                                let cholestralDictionary = usdaFieldsDictionary["CHOLE"]! as NSDictionary
                                if cholestralDictionary["value"] != nil {
                                    let cholestralValue: AnyObject = cholestralDictionary["value"]!
                                    usdaItem.cholesteral = "\(cholestralValue)"
                                }
                            }
                            else {
                                usdaItem.cholesteral = "0"
                            }
